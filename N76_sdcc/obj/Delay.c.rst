      ...
      00017C                        575 _Timer0_Delay100us:
                           ...
                           000001   582 	ar1 = 0x01
                           000000   583 	ar0 = 0x00
      00017C AC 82            [24]  584 	mov	r4,dpl
      00017E AD 83            [24]  585 	mov	r5,dph
      000180 AE F0            [24]  586 	mov	r6,b
      000182 FF               [12]  587 	mov	r7,a
                                    588 ;	lib/Delay.c:24: clr_T0M;                                		//T0M=0, Timer0 Clock = Fsys/12
      000183 53 8E F7         [24]  589 	anl	_CKCON,#0xf7
                                    590 ;	lib/Delay.c:25: TMOD |= 0x01;                         		  //Timer0 is 16-bit mode
      000186 43 89 01         [24]  591 	orl	_TMOD,#0x01
                                    592 ;	lib/Delay.c:26: set_TR0;                            		    //Start Timer0
                                    593 ;	assignBit
      000189 D2 8C            [12]  594 	setb	_TR0
                                    595 ;	lib/Delay.c:27: while (u32CNT != 0)
      00018B                        596 00104$:
      00018B EC               [12]  597 	mov	a,r4
      00018C 4D               [12]  598 	orl	a,r5
      00018D 4E               [12]  599 	orl	a,r6
      00018E 4F               [12]  600 	orl	a,r7
      00018F 60 1A            [24]  601 	jz	00106$
                                    602 ;	lib/Delay.c:29: TL0 = LOBYTE(TIMER_DIV12_VALUE_100us);	//Find  define in "Function_define.h" "TIMER VALUE"
      000191 75 8A 7E         [24]  603 	mov	_TL0,#0x7e
                                    604 ;	lib/Delay.c:30: TH0 = HIBYTE(TIMER_DIV12_VALUE_100us);
      000194 75 8C FF         [24]  605 	mov	_TH0,#0xff
                                    606 ;	lib/Delay.c:31: while (TF0 != 1);       		            //Check Timer0 Time-Out Flag
      000197                        607 00101$:
                                    608 ;	lib/Delay.c:32: clr_TF0;
                                    609 ;	assignBit
      000197 10 8D 02         [24]  610 	jbc	_TF0,00127$
      00019A 80 FB            [24]  611 	sjmp	00101$
      00019C                        612 00127$:
                                    613 ;	lib/Delay.c:33: u32CNT --;
      00019C 1C               [12]  614 	dec	r4
      00019D BC FF 09         [24]  615 	cjne	r4,#0xff,00128$
      0001A0 1D               [12]  616 	dec	r5
      0001A1 BD FF 05         [24]  617 	cjne	r5,#0xff,00128$
      0001A4 1E               [12]  618 	dec	r6
      0001A5 BE FF 01         [24]  619 	cjne	r6,#0xff,00128$
      0001A8 1F               [12]  620 	dec	r7
      0001A9                        621 00128$:
      0001A9 80 E0            [24]  622 	sjmp	00104$
      0001AB                        623 00106$:
                                    624 ;	lib/Delay.c:35: clr_TR0;                       			        //Stop Timer0
                                    625 ;	assignBit
      0001AB C2 8C            [12]  626 	clr	_TR0
                                    627 ;	lib/Delay.c:36: }
      0001AD 22               [24]  628 	ret
                                    629 ;------------------------------------------------------------
                                    ...
                                    637 ;	-----------------------------------------
      0001AE                        638 _Timer0_Delay1ms:
      0001AE AC 82            [24]  639 	mov	r4,dpl
      0001B0 AD 83            [24]  640 	mov	r5,dph
      0001B2 AE F0            [24]  641 	mov	r6,b
      0001B4 FF               [12]  642 	mov	r7,a
                                    643 ;	lib/Delay.c:40: clr_T0M;                                		//T0M=0, Timer0 Clock = Fsys/12
      0001B5 53 8E F7         [24]  644 	anl	_CKCON,#0xf7
                                    645 ;	lib/Delay.c:41: TMOD |= 0x01;                           		//Timer0 is 16-bit mode
      0001B8 43 89 01         [24]  646 	orl	_TMOD,#0x01
                                    647 ;	lib/Delay.c:42: set_TR0;                              		  //Start Timer0
                                    648 ;	assignBit
      0001BB D2 8C            [12]  649 	setb	_TR0
                                    650 ;	lib/Delay.c:43: while (u32CNT != 0)
      0001BD                        651 00104$:
      0001BD EC               [12]  652 	mov	a,r4
      0001BE 4D               [12]  653 	orl	a,r5
      0001BF 4E               [12]  654 	orl	a,r6
      0001C0 4F               [12]  655 	orl	a,r7
      0001C1 60 1A            [24]  656 	jz	00106$
                                    657 ;	lib/Delay.c:45: TL0 = LOBYTE(TIMER_DIV12_VALUE_1ms); 		//Find  define in "Function_define.h" "TIMER VALUE"
      0001C3 75 8A CA         [24]  658 	mov	_TL0,#0xca
                                    659 ;	lib/Delay.c:46: TH0 = HIBYTE(TIMER_DIV12_VALUE_1ms);
      0001C6 75 8C FA         [24]  660 	mov	_TH0,#0xfa
                                    661 ;	lib/Delay.c:47: while (TF0 != 1);                   		//Check Timer0 Time-Out Flag
      0001C9                        662 00101$:
                                    663 ;	lib/Delay.c:48: clr_TF0;
                                    664 ;	assignBit
      0001C9 10 8D 02         [24]  665 	jbc	_TF0,00127$
      0001CC 80 FB            [24]  666 	sjmp	00101$
      0001CE                        667 00127$:
                                    668 ;	lib/Delay.c:49: u32CNT --;
      0001CE 1C               [12]  669 	dec	r4
      0001CF BC FF 09         [24]  670 	cjne	r4,#0xff,00128$
      0001D2 1D               [12]  671 	dec	r5
      0001D3 BD FF 05         [24]  672 	cjne	r5,#0xff,00128$
      0001D6 1E               [12]  673 	dec	r6
      0001D7 BE FF 01         [24]  674 	cjne	r6,#0xff,00128$
      0001DA 1F               [12]  675 	dec	r7
      0001DB                        676 00128$:
      0001DB 80 E0            [24]  677 	sjmp	00104$
      0001DD                        678 00106$:
                                    679 ;	lib/Delay.c:51: clr_TR0;                              		  //Stop Timer0
                                    680 ;	assignBit
      0001DD C2 8C            [12]  681 	clr	_TR0
                                    682 ;	lib/Delay.c:52: }
      0001DF 22               [24]  683 	ret
                                    684 ;------------------------------------------------------------
                                    ...
                                    692 ;	-----------------------------------------
      0001E0                        693 _Timer1_Delay10ms:
      0001E0 AC 82            [24]  694 	mov	r4,dpl
      0001E2 AD 83            [24]  695 	mov	r5,dph
      0001E4 AE F0            [24]  696 	mov	r6,b
      0001E6 FF               [12]  697 	mov	r7,a
                                    698 ;	lib/Delay.c:57: clr_T1M;																		//T1M=0, Timer1 Clock = Fsys/12
      0001E7 53 8E EF         [24]  699 	anl	_CKCON,#0xef
                                    700 ;	lib/Delay.c:58: TMOD |= 0x10;																//Timer1 is 16-bit mode
      0001EA 43 89 10         [24]  701 	orl	_TMOD,#0x10
                                    702 ;	lib/Delay.c:59: set_TR1;																		//Start Timer1
                                    703 ;	assignBit
      0001ED D2 8E            [12]  704 	setb	_TR1
                                    705 ;	lib/Delay.c:60: while (u32CNT != 0)
      0001EF                        706 00104$:
      0001EF EC               [12]  707 	mov	a,r4
      0001F0 4D               [12]  708 	orl	a,r5
      0001F1 4E               [12]  709 	orl	a,r6
      0001F2 4F               [12]  710 	orl	a,r7
      0001F3 60 1A            [24]  711 	jz	00106$
                                    712 ;	lib/Delay.c:62: TL1 = LOBYTE(TIMER_DIV12_VALUE_10ms);		//Find  define in "Function_define.h" "TIMER VALUE"
      0001F5 75 8B EA         [24]  713 	mov	_TL1,#0xea
                                    714 ;	lib/Delay.c:63: TH1 = HIBYTE(TIMER_DIV12_VALUE_10ms);
      0001F8 75 8D CB         [24]  715 	mov	_TH1,#0xcb
                                    716 ;	lib/Delay.c:64: while (TF1 != 1);												//Check Timer1 Time-Out Flag
      0001FB                        717 00101$:
                                    718 ;	lib/Delay.c:65: clr_TF1;
                                    719 ;	assignBit
      0001FB 10 8F 02         [24]  720 	jbc	_TF1,00127$
      0001FE 80 FB            [24]  721 	sjmp	00101$
      000200                        722 00127$:
                                    723 ;	lib/Delay.c:66: u32CNT --;
      000200 1C               [12]  724 	dec	r4
      000201 BC FF 09         [24]  725 	cjne	r4,#0xff,00128$
      000204 1D               [12]  726 	dec	r5
      000205 BD FF 05         [24]  727 	cjne	r5,#0xff,00128$
      000208 1E               [12]  728 	dec	r6
      000209 BE FF 01         [24]  729 	cjne	r6,#0xff,00128$
      00020C 1F               [12]  730 	dec	r7
      00020D                        731 00128$:
      00020D 80 E0            [24]  732 	sjmp	00104$
      00020F                        733 00106$:
                                    734 ;	lib/Delay.c:68: clr_TR1;                               			//Stop Timer1
                                    735 ;	assignBit
      00020F C2 8E            [12]  736 	clr	_TR1
                                    737 ;	lib/Delay.c:69: }
      000211 22               [24]  738 	ret
                                    739 ;------------------------------------------------------------
                                    ...
                                    747 ;	-----------------------------------------
      000212                        748 _Timer2_Delay500us:
      000212 AC 82            [24]  749 	mov	r4,dpl
      000214 AD 83            [24]  750 	mov	r5,dph
      000216 AE F0            [24]  751 	mov	r6,b
      000218 FF               [12]  752 	mov	r7,a
                                    753 ;	lib/Delay.c:73: clr_T2DIV2;																	//Timer2 Clock = Fsys/4 
      000219 53 C9 BF         [24]  754 	anl	_T2MOD,#0xbf
                                    755 ;	lib/Delay.c:74: clr_T2DIV1;
      00021C 53 C9 DF         [24]  756 	anl	_T2MOD,#0xdf
                                    757 ;	lib/Delay.c:75: set_T2DIV0;
      00021F 43 C9 10         [24]  758 	orl	_T2MOD,#0x10
                                    759 ;	lib/Delay.c:76: set_TR2;                                		//Start Timer2
                                    760 ;	assignBit
      000222 D2 CA            [12]  761 	setb	_TR2
                                    762 ;	lib/Delay.c:77: while (u32CNT != 0)
      000224                        763 00104$:
      000224 EC               [12]  764 	mov	a,r4
      000225 4D               [12]  765 	orl	a,r5
      000226 4E               [12]  766 	orl	a,r6
      000227 4F               [12]  767 	orl	a,r7
      000228 60 1A            [24]  768 	jz	00106$
                                    769 ;	lib/Delay.c:79: TL2 = LOBYTE(TIMER_DIV4_VALUE_500us);		//Find  define in "Function_define.h" "TIMER VALUE"
      00022A 75 CC 30         [24]  770 	mov	_TL2,#0x30
                                    771 ;	lib/Delay.c:80: TH2 = HIBYTE(TIMER_DIV4_VALUE_500us);
      00022D 75 CD F8         [24]  772 	mov	_TH2,#0xf8
                                    773 ;	lib/Delay.c:81: while (TF2 != 1);                   		//Check Timer2 Time-Out Flag
      000230                        774 00101$:
                                    775 ;	lib/Delay.c:82: clr_TF2;
                                    776 ;	assignBit
      000230 10 CF 02         [24]  777 	jbc	_TF2,00127$
      000233 80 FB            [24]  778 	sjmp	00101$
      000235                        779 00127$:
                                    780 ;	lib/Delay.c:83: u32CNT --;
      000235 1C               [12]  781 	dec	r4
      000236 BC FF 09         [24]  782 	cjne	r4,#0xff,00128$
      000239 1D               [12]  783 	dec	r5
      00023A BD FF 05         [24]  784 	cjne	r5,#0xff,00128$
      00023D 1E               [12]  785 	dec	r6
      00023E BE FF 01         [24]  786 	cjne	r6,#0xff,00128$
      000241 1F               [12]  787 	dec	r7
      000242                        788 00128$:
      000242 80 E0            [24]  789 	sjmp	00104$
      000244                        790 00106$:
                                    791 ;	lib/Delay.c:85: clr_TR2;                                		//Stop Timer2
                                    792 ;	assignBit
      000244 C2 CA            [12]  793 	clr	_TR2
                                    794 ;	lib/Delay.c:86: }
      000246 22               [24]  795 	ret
                                    796 ;------------------------------------------------------------
                                    ...
                                    804 ;	-----------------------------------------
      000247                        805 _Timer3_Delay100ms:
      000247 AC 82            [24]  806 	mov	r4,dpl
      000249 AD 83            [24]  807 	mov	r5,dph
      00024B AE F0            [24]  808 	mov	r6,b
      00024D FF               [12]  809 	mov	r7,a
                                    810 ;	lib/Delay.c:90: T3CON = 0x07;                           		//Timer3 Clock = Fsys/128
      00024E 75 C4 07         [24]  811 	mov	_T3CON,#0x07
                                    812 ;	lib/Delay.c:91: set_TR3;                                		//Trigger Timer3
      000251 43 C4 08         [24]  813 	orl	_T3CON,#0x08
                                    814 ;	lib/Delay.c:92: while (u32CNT != 0)
      000254                        815 00104$:
      000254 EC               [12]  816 	mov	a,r4
      000255 4D               [12]  817 	orl	a,r5
      000256 4E               [12]  818 	orl	a,r6
      000257 4F               [12]  819 	orl	a,r7
      000258 60 25            [24]  820 	jz	00106$
                                    821 ;	lib/Delay.c:94: RL3 = LOBYTE(TIMER_DIV128_VALUE_100ms); //Find  define in "Function_define.h" "TIMER VALUE"
      00025A 75 C5 2C         [24]  822 	mov	_RL3,#0x2c
                                    823 ;	lib/Delay.c:95: RH3 = HIBYTE(TIMER_DIV128_VALUE_100ms);
      00025D 75 C6 CF         [24]  824 	mov	_RH3,#0xcf
                                    825 ;	lib/Delay.c:96: while ((T3CON&SET_BIT4) != SET_BIT4);		//Check Timer3 Time-Out Flag
      000260                        826 00101$:
      000260 AA C4            [24]  827 	mov	r2,_T3CON
      000262 53 02 10         [24]  828 	anl	ar2,#0x10
      000265 7B 00            [12]  829 	mov	r3,#0x00
      000267 BA 10 F6         [24]  830 	cjne	r2,#0x10,00101$
      00026A BB 00 F3         [24]  831 	cjne	r3,#0x00,00101$
                                    832 ;	lib/Delay.c:97: clr_TF3;
      00026D 53 C4 EF         [24]  833 	anl	_T3CON,#0xef
                                    834 ;	lib/Delay.c:98: u32CNT --;
      000270 1C               [12]  835 	dec	r4
      000271 BC FF 09         [24]  836 	cjne	r4,#0xff,00129$
      000274 1D               [12]  837 	dec	r5
      000275 BD FF 05         [24]  838 	cjne	r5,#0xff,00129$
      000278 1E               [12]  839 	dec	r6
      000279 BE FF 01         [24]  840 	cjne	r6,#0xff,00129$
      00027C 1F               [12]  841 	dec	r7
      00027D                        842 00129$:
      00027D 80 D5            [24]  843 	sjmp	00104$
      00027F                        844 00106$:
                                    845 ;	lib/Delay.c:100: clr_TR3;                                		//Stop Timer3
      00027F 53 C4 F7         [24]  846 	anl	_T3CON,#0xf7
                                    847 ;	lib/Delay.c:101: }
      000282 22               [24]  848 	ret
                                    849 ;------------------------------------------------------------
                                    ...
                                    857 ;	-----------------------------------------
      000283                        858 _Timer3_Delay10us:
      000283 AC 82            [24]  859 	mov	r4,dpl
      000285 AD 83            [24]  860 	mov	r5,dph
      000287 AE F0            [24]  861 	mov	r6,b
      000289 FF               [12]  862 	mov	r7,a
                                    863 ;	lib/Delay.c:105: T3CON = 0x07;                           		//Timer3 Clock = Fsys/128
      00028A 75 C4 07         [24]  864 	mov	_T3CON,#0x07
                                    865 ;	lib/Delay.c:106: set_TR3;                                		//Trigger Timer3
      00028D 43 C4 08         [24]  866 	orl	_T3CON,#0x08
                                    867 ;	lib/Delay.c:107: while (u32CNT != 0)
      000290                        868 00104$:
      000290 EC               [12]  869 	mov	a,r4
      000291 4D               [12]  870 	orl	a,r5
      000292 4E               [12]  871 	orl	a,r6
      000293 4F               [12]  872 	orl	a,r7
      000294 60 25            [24]  873 	jz	00106$
                                    874 ;	lib/Delay.c:109: RL3 = LOBYTE(TIMER_DIV4_VALUE_10us); //Find  define in "Function_define.h" "TIMER VALUE"
      000296 75 C5 D8         [24]  875 	mov	_RL3,#0xd8
                                    876 ;	lib/Delay.c:110: RH3 = HIBYTE(TIMER_DIV4_VALUE_10us);
      000299 75 C6 FF         [24]  877 	mov	_RH3,#0xff
                                    878 ;	lib/Delay.c:111: while ((T3CON&SET_BIT4) != SET_BIT4);		//Check Timer3 Time-Out Flag
      00029C                        879 00101$:
      00029C AA C4            [24]  880 	mov	r2,_T3CON
      00029E 53 02 10         [24]  881 	anl	ar2,#0x10
      0002A1 7B 00            [12]  882 	mov	r3,#0x00
      0002A3 BA 10 F6         [24]  883 	cjne	r2,#0x10,00101$
      0002A6 BB 00 F3         [24]  884 	cjne	r3,#0x00,00101$
                                    885 ;	lib/Delay.c:112: clr_TF3;
      0002A9 53 C4 EF         [24]  886 	anl	_T3CON,#0xef
                                    887 ;	lib/Delay.c:113: u32CNT --;
      0002AC 1C               [12]  888 	dec	r4
      0002AD BC FF 09         [24]  889 	cjne	r4,#0xff,00129$
      0002B0 1D               [12]  890 	dec	r5
      0002B1 BD FF 05         [24]  891 	cjne	r5,#0xff,00129$
      0002B4 1E               [12]  892 	dec	r6
      0002B5 BE FF 01         [24]  893 	cjne	r6,#0xff,00129$
      0002B8 1F               [12]  894 	dec	r7
      0002B9                        895 00129$:
      0002B9 80 D5            [24]  896 	sjmp	00104$
      0002BB                        897 00106$:
                                    898 ;	lib/Delay.c:115: clr_TR3;                                		//Stop Timer3
      0002BB 53 C4 F7         [24]  899 	anl	_T3CON,#0xf7
                                    900 ;	lib/Delay.c:116: }
      0002BE 22               [24]  901 	ret
                                    902 	.area CSEG    (CODE)
                                    903 	.area CONST   (CODE)
